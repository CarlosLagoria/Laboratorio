...
public class VentanaActualizarPelicula extends JFrame{
    ...
    JLabel Ltitulo2 = new JLabel("INGRESE EL CODIGO DE LA PELICULA A MODIFICAR");
    JLabel Lcodigo2 = new JLabel("CODIGO DE LA PELICULA A MODIFICAR");
    ...
    class ManejadorEventos implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == aceptar) {
                ...
                try {
                    ...
                    Logger.getLogger(VentanaActualizarPelicula.class.getName()).log(Level.SEVERE, null, ex);
                }
        ...
        public void modificar() throws DataAccessException {
            if (Tcodigo2.getText().isEmpty() || Tcodigo.getText().isEmpty() || Tgenero.getText().isEmpty() || Ttitulo.getText().isEmpty() || Tformato.getText().isEmpty()
                ...
                gestor.actualizarPelicula(pelicula, codigo2);
