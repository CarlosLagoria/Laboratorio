...
public class VentanaEliminarRegistro extends JFrame{
    ...
    JLabel Ltitulo2 = new JLabel("INGRESE EL NUMERO DE REGISTRO A ELIMINAR");
    ...
    public VentanaEliminarRegistro() {
    ...
    class ManejadorEventos implements ActionListener {
        ...
        public void eliminar() throws DataAccessException {
            if (Tregistro2.getText().isEmpty()) {
                ...
                gestor.eliminarRegistro(registrobuscar);
