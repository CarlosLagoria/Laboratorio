...
public class VentanaGananciaEnMultas extends JFrame{
    ...
    JLabel Ltitulo2 = new JLabel("LA GANANCIA EN CONCEPTO DE MULTAS ES: ");
    JLabel Lganancia = new JLabel("$");

    public VentanaGananciaEnMultas() {

        super("Ganancia en concepto de Multas");
    ...
    class ManejadorEventos implements ActionListener {
        ...
        public void calcular() throws DataAccessException {
            if (Tfechainicio.getText().isEmpty() || Tfechafin.getText().isEmpty()) {
                ...
                float monto = gestor.sumamultas(fechainicio, fechafin);
